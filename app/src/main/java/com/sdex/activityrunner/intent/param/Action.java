...
//      put("ACTION_POWER_DISCONNECTED", Intent.ACTION_POWER_DISCONNECTED);
      ...
      put("ACTION_PROVIDER_CHANGED", Intent.ACTION_PROVIDER_CHANGED);
...
//      put("ACTION_SHUTDOWN", Intent.ACTION_SHUTDOWN);
      ...
      put("ACTION_TIME_CHANGED", Intent.ACTION_TIME_CHANGED);
...
//      put("ACTION_UID_REMOVED", Intent.ACTION_UID_REMOVED);
      ...
      if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
        put("ACTION_USER_BACKGROUND", Intent.ACTION_USER_BACKGROUND);
      }
      if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
        put("ACTION_USER_FOREGROUND", Intent.ACTION_USER_FOREGROUND);
      }
      if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
...
//      put("ACTION_USER_PRESENT", Intent.ACTION_USER_PRESENT);
      if (VERSION.SDK_INT >= VERSION_CODES.N) {
        put("ACTION_USER_UNLOCKED", Intent.ACTION_USER_UNLOCKED);
      }
...
//      put("ACTION_DEVICE_STORAGE_OK", Intent.ACTION_DEVICE_STORAGE_OK);
      put("ACTION_UMS_CONNECTED", Intent.ACTION_UMS_CONNECTED);
      put("ACTION_UMS_DISCONNECTED", Intent.ACTION_UMS_DISCONNECTED);
      put("ACTION_WALLPAPER_CHANGED", Intent.ACTION_WALLPAPER_CHANGED);
    }
  };
